...
TEMPLATE;
    ...
    public function build_preamble($context, $user_id) {
        ...
        if ($has_history) {
            ...
            $preamble .= "If the student chose A (Generate a question): You MUST generate a complete exam question with extract using the EXAM QUESTION FORMAT REFERENCE. Present it in full. Do NOT skip this.\n";
