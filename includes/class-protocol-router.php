    ...
    private function load_modular_protocol($context, $user_id = 0) {
        ...
        if (strpos($task, 'cw_step_') === 0 || strpos($task, 'cw_trial_') === 0) {
            $cw_protocol_map = [
                ...
                'cw_step_18' => 'CW-STEP-18-deepen-empathy.md',
                'cw_step_19' => 'CW-STEP-19-update-plot-empathy.md',
                'cw_step_20' => 'CW-STEP-20-draft-4-empathy.md',
                'cw_step_21' => 'CW-STEP-21-theme-tone.md',
                'cw_step_22' => 'CW-STEP-22-update-plot-theme.md',
                'cw_step_23' => 'CW-STEP-23-draft-5-theme-tone.md',
                'cw_step_24' => 'CW-STEP-24-genre.md',
                'cw_step_25' => 'CW-STEP-25-update-plot-genre.md',
                'cw_step_26' => 'CW-STEP-26-draft-6-genre.md',
                'cw_step_27' => 'CW-STEP-27-structural-elements.md',
                'cw_step_28' => 'CW-STEP-28-update-plot-structural.md',
                'cw_step_29' => 'CW-STEP-29-draft-7-structural-elements.md',
    ...
    public function build_preamble($context, $user_id) {
        ...
        if (strpos($task, 'cw_step_') === 0 || strpos($task, 'cw_trial_') === 0) {
            $cw_step_labels = [
                ...
                'cw_step_13' => 'Scene Selection: Draft 2', 'cw_step_14' => 'Draft 2: Character Arc', 'cw_step_15' => 'Character Archetypes',
                'cw_step_16' => 'Update Plot: Archetypes', 'cw_step_17' => 'Draft 3: Archetypes',
                'cw_step_18' => 'Deepen Empathy', 'cw_step_19' => 'Update Plot: Empathy',
                'cw_step_20' => 'Draft 4: Empathy', 'cw_step_21' => 'Theme & Tone',
                'cw_step_22' => 'Update Plot: Theme', 'cw_step_23' => 'Draft 5: Theme & Tone',
                'cw_step_24' => 'Genre', 'cw_step_25' => 'Update Plot: Genre',
                'cw_step_26' => 'Draft 6: Genre', 'cw_step_27' => 'Structural Elements',
