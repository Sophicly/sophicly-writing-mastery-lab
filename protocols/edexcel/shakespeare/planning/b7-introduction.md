...
1. **Surprising Historical Fact:** A striking, unexpected fact that challenges assumptions (e.g., 'In 1606, just months after the Gunpowder Plot threatened James I's life, Shakespeare wrote Macbeth—a play exploring regicide and legitimate succession')  
...
3. **Intriguing Quote:** A memorable, paradoxical, or startling quote that illuminates your theme (e.g., 'Shakespeare himself observed in Hamlet: "There is nothing either good or bad, but thinking makes it so"—a haunting truth about moral corruption')  
...
→ **LEVEL 2 \- Provide technique categories:** "Think about the main stylistic approaches in Shakespearean drama. Does \[author\] rely on: rich poetic imagery, soliloquy and direct address, dramatic irony, verse structure and rhythm, metaphorical language, or stage spectacle? Which dominates THIS extract?"
...
- Hook: Extract 3-5 core keywords (e.g., "Jacobean England" "1606" "regicide" "divine right" "political anxiety")  
...
- Thesis: Extract 5-8 thesis keywords (e.g., "Macbeth" "presents" "ambition's corruption" "destroying" "moral conscience" "legitimate kingship")

**STANDARD MODE (Introduction):**

- Hook: Break into phrase chunks, NOT complete sentence (e.g., "Jacobean England 1606" | "regicide fears" | "political succession crisis")  
- Building Sentences: Break into phrase chunks, NOT complete sentences (e.g., "Shakespeare employs disease imagery" | "dramatic irony technique" | "exposes ambition's psychology")  
- Thesis: Break into phrase chunks, NOT complete sentence (e.g., "Macbeth presents ambition's corruption" | "destroying moral conscience" | "undermining legitimate kingship")
...
- Building Sentences: Break into phrase chunks, NOT complete sentences (e.g., "Shakespeare explores revenge morality" | "what constitutes justice" | "corruption vs action")  
