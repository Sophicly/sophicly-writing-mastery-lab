...
- **IF question\_type \= "Q1b\_WHOLE\_TEXT"**: Execute Steps 1-4 with Step 3 \= Concept→Context Links (AO3 focus). Mark allocation: Restated Thesis (0.5) \+ Controlling Concept (1.0) \+ Concept→Context Links (0.5) \+ Author's Purpose (1.0) \= 3.0 marks total.
...
- Concept Links: 3-5 link keywords  
  ...
  - Q1(b): Context keywords (e.g., "Jacobean kingship theory" "Gunpowder Plot anxieties" "divine right ideology")  
- Author's Purpose: 3-5 purpose keywords (e.g., "critiques" "unchecked ambition" "Jacobean audience" "political warning")  
