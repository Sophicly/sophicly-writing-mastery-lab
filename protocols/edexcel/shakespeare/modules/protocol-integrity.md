...
3. **Execute Phase Logic:** Run the relevant assessment, planning, or polishing routine for the current phase.  
   ...
   * In **Assessment (Protocol A)**, provide complete essay submission option (not paragraph-by-paragraph). Apply marking criteria precisely to Edexcel GCSE Level 1-5 descriptors.  
...
4. **Assess & Mark (Assessment Protocol Only):**  
   ...
   * **Cross-reference with Edexcel GCSE Mark Scheme levels (Level 1-5 descriptors)** to ensure alignment.  
...
**Edexcel GCSE English Literature Paper 1 Section A (Shakespeare/Drama) Assessment Objectives:**
...
**For Question 1(a):** Context is NOT separately assessed as AO3. However, understanding historical, social, and biographical context remains pedagogically essential for developing "critical style and informed personal engagement" (AO1) and perceptive analysis of writer's methods (AO2). Context should be integrated naturally to support AO1/AO2 analysis, not treated as a separate objective.

**For Question 1(b):** Context IS assessed as AO3 (5 marks). Students must refer to the context of the play in their answer, demonstrating how historical, social, or cultural factors shape Shakespeare's presentation of themes and characters.

**Mark Distribution:**

**Question 1(a) (Extract \- 20 marks total):**

* AO1 and AO2 are equally weighted \- **NO AO3, NO AO4**  
* Level 5: 16-20 marks | Level 4: 10-12 | Level 3: 7-9 | Level 2: 4-6 | Level 1: 1-3  
* Indicative breakdown for pedagogy: 2 (intro) \+ 5+5+5 (body) \+ 3 (conclusion) \= 20 marks

**Question 1(b) (Whole Text \- 20 marks total):**

* AO1: 15 marks \+ AO3: 5 marks \= 20 marks total  
  - Level 5: 17-20 marks | Level 4: 13-16 | Level 3: 9-12 | Level 2: 5-8 | Level 1: 1-4  
  - Indicative breakdown: 2 (intro) \+ 5+5+5 (body) \+ 3 (conclusion) \= 20 marks  
  - **AO1 (15 marks):** Textual knowledge, critical style, personal engagement  
  - **AO3 (5 marks):** Understanding of context and its relationship to the text

**Before sending any feedback, execute AO\_EDEXCEL\_SANITY():**

* For Q1(a): Ensure Assessment Objective references are ONLY to AO2 (language, form, structure)  
* For Q1(b): Ensure Assessment Objective references are to AO1 (textual knowledge, critical style) and AO3 (context)  
* Verify marks align with Edexcel GCSE Level 1-5 descriptors  
* For Q1(a): Context should be referenced naturally as supporting analysis, not as a separate objective  
* For Q1(b): Context MUST be assessed as AO3 (5 marks) \- students must refer to context in their answer
