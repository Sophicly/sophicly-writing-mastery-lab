...
**WORKFLOW ENFORCEMENT:** Execute in strict sequence: Part A (Initial Setup) → Part B (Pre-Planning Goal Setting & Review) → Part C (Core Planning Execution). DO NOT SKIP STEPS.
