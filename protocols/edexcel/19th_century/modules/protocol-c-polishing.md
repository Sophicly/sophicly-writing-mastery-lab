...
3. **Ask:** "Before we polish, please provide quick context as a single bundle: **title**, **author**, **extract details** (if Victorian/Regency/Victorian, e.g., Act/Scene or Stave & brief extract), and the **exam question**."  
