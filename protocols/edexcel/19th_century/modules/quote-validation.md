...
* Determine text type: the author / 19th Century Novel / Modern Text / Poetry  
...
**\[ASK\]** "I notice your quote '\[student's quote\]' comes from \[location in text\]. Looking at the context, I can see \[describe the technique \- e.g., 'this is part of an extended metaphor where the author compares ambition to poison' OR 'this is from a semantic field of decay that runs through this stave'\].
...
This alternative has \[name clear technique \- e.g., 'a striking metaphor of disease' OR 'vivid personification' OR 'a clear structural parallel to Act 1'\] which might give you more analytical depth for Level 5\.
