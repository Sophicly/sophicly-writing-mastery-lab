...
- Is there a **specific aspect** mentioned? For example: 'the protagonist's **relationship with** Lady the protagonist' (not the protagonist generally), or 'Scrooge's **treatment of** the poor' (not Scrooge's character generally)?  
...
**\[AI\_INTERNAL\]** If question includes extract, say: "I notice your question includes an extract. Edexcel GCSE requires you to reference the extract in your essay. We'll ensure one of your three anchor quotes comes from this extract when we select quotes shortly."
