...
Say: "Let me give you more specific keywords from Body \[X\]: \[4-5 keywords now, including protagonist name and key theme words \- e.g., "Scrooge" "redemption" "isolation" "social responsibility"\]
...
Say: "Perfect. Now draft a working thesis that states this overarching concept and foreshadows your three proving concepts (one per body). Aim for the 'precise' and 'perceptive' language that Level 5 requires."
