...
**Readiness Check:** "Ready to plan your comparative introduction to Level 4-5 standard? Type '**ready**' when you are."
...
Say: "Excellent comparative hook. Let me verify it meets Level 4-5 criteria:
...
Say: "I can see you're working on your hook, but let's strengthen it to meet comparative Level 4-5 criteria. \[Identify specific issue: not comparative/stock phrase/generic/disconnected\]"
...
For Level 4-5's 'detailed understanding of comparative context,' think about:
...
→ **LEVEL 3 \- Deploy comparative "Did You Know":** Provide text-specific comparative contextual insight, then return to Level 1 with new perspective.
...
Say: "Let me check these building sentences meet comparative Level 4-5 criteria:
