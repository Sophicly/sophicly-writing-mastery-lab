...
* Determine text type: Modern Drama or Modern Prose  
* Identify the surrounding context of each quote in the source text  
* Note the act/scene or chapter location
...
**\[ASK\]** "I notice your quote '\[student's quote\]' comes from \[location in text\]. Looking at the context, I can see \[describe the technique \- e.g., 'this is part of an extended metaphor where Priestley compares social responsibility to interconnected chains' OR 'this is from a semantic field of decay that runs through this stave'\].
...
This alternative has \[name clear technique \- e.g., 'a striking metaphor of disease' OR 'vivid personification' OR 'a clear structural parallel to Act 1'\] which might give you more analytical depth for Level 4-5 content standard (20-32 marks for AO1+AO3).
