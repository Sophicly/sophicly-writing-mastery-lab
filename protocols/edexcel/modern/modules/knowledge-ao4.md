## **0.2A AO4 Assessment (Modern Drama & Prose)**

**\[AI\_INTERNAL\]** **AO4** (Technical Accuracy) is assessed for ALL modern drama and prose texts in Edexcel GCSE English Literature.
...
* Award 0-8 marks using the 3-level system (Level 1: 1-2 marks, Level 2: 3-5 marks, Level 3: 6-8 marks)  
* Add to total marks (32 content \+ **AO4** \= 40 maximum)
...
* Character/author names (e.g., "Sheila" not "Shiela", "Priestley" not "Priestly")  
...
* Imprecise verbs ("shows" \- though this also weakens **AO1** interpretation)

### **Integration with Main Assessment**

**During Assessment Protocol A:**

1. Complete Introduction assessment → award marks out of 5  
2. Complete Body Paragraph 1 assessment → award marks out of 7.5  
3. Complete Body Paragraph 2 assessment → award marks out of 7.5  
4. Complete Body Paragraph 3 assessment → award marks out of 7.5  
5. Complete Conclusion assessment → award marks out of 5.5  
6. Complete **AO4** holistic assessment → award marks out of 8  
