...
**Note on Context-Concept Relationship:** For Edexcel modern drama/prose, context (**AO3**) is explicitly assessed alongside conceptual understanding (**AO1**). Students must demonstrate how historical, social, and literary context directly drives the concepts within the text. Strong essays show how concepts emerge from and are shaped by contextual forces, which in turn illuminate the author's language and structural choices (analyzed to strengthen **AO1** interpretation, not separately assessed as AO2).
