...
- Is there a **specific aspect** mentioned? For example: 'The Inspector's **relationship with** the Birlings' (not the Inspector generally), or 'Piggy's **treatment by** the other boys' (not Piggy's character generally)?  
...
**\[AI\_INTERNAL\]** If question includes extract, say: "I notice your question includes an extract. Edexcel requires you to reference the extract in your essay. We'll ensure one of your three anchor quotes comes from this extract when we select quotes shortly."
