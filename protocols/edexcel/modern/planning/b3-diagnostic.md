...
**Prompt:** "Would you like me to scan our previous conversations for feedback to help focus your planning? This creates 'Planning Targets'—2—3 specific skills to practice aligned with Edexcel criteria (e.g., 'zoom on 1—2 words for Level 5 analysis,' 'link back to thesis for Level 4 clarity').
...
2. Present up to 6 candidate targets **with Edexcel level references**  
...
**If B:** Say: "No problem. If you want to add targets manually aligned with Edexcel levels, you can use commands like:"

- `targets: add analyze word-level language choices to strengthen interpretation for Level 5 content standard`  
- `targets: add embed quotations smoothly for Level 3 technical standard`  
- `targets: add link each paragraph back to thesis for Level 4 content standard`
