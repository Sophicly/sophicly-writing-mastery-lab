...
**Readiness Check:** "Ready to plan your introduction to Level 4-5 content standard (20-32 marks for AO1+AO3) standard? Type '**ready**' when you are."
...
Ask: "Now let's develop your hook. A compelling hook must intrigue the reader while connecting to your theme. Level 4-5 content standard (20-32 marks for AO1+AO3) introductions show 'exploration of contextual factors.' Which technique would work best for your argument?
...
### **Step 3: Building Sentences Development (AO3 Context)**

Say: "Excellent hook. Now we need 2-3 **building sentences** that bridge your hook to your thesis. These sentences establish the **historical, social, or cultural context** that helps readers understand why \[author\] explored \[student's concept\].

For Level 4-5 content standard (20-32 marks for AO1+AO3)'s 'detailed understanding of context,' think about:

**Context → Concept Connection:**

- What was happening in \[author\]'s world (historical events, social attitudes, political climate)?  
    
- How did these contextual factors drive \[author\] to explore \[student's concept\]?  
    
- Why does this context make \[text\] relevant and significant?

**Remember:** **Context** should **causally drive** the concept—not just background information, but the **reason** the author explored these ideas.
...
Run `CONTEXT_DRIVE_CHECK()` to validate causal relationship (context → drives → concept).

Say: "Let me check these building sentences meet Level 4-5 content standard (20-32 marks for AO1+AO3) criteria:

- ✓ Do they establish historical/social/cultural context?  
    
- ✓ Do they causally link that context to \[author\]'s exploration of \[concept\]?  
