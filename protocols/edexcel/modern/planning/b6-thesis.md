...
Say: "Let me give you more specific keywords from Body \[X\]: \[4-5 keywords now, including protagonist name and key theme words \- e.g., "Inspector" "responsibility" "interconnected" "social conscience"\]
...
Say: "Perfect. Now draft a working thesis that states this overarching concept and foreshadows your three proving concepts (one per body). Aim for the 'precise' and 'perceptive' language that Level 5 content standard (27-32 marks for AO1+AO3) requires."
