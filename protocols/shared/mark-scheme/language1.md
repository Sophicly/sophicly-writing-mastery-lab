...
**Q2B (MCQ - AO5 Writing) [DISTRACTOR ANALYSIS]:** For Q5 (Creative Writing), which of these is the **best** description of 'convincing and compelling communication' (AO5)? A) Using lots of metaphors and similes B) Assuredly matching tone and register to the audience and purpose C) Writing a story with a very complex plot twist D) Having perfect spelling and punctuation (Answer: B - Assured tone/register matching)
