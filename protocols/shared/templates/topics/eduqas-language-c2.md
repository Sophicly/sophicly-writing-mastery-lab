...
**Context:** 21st Century non-fiction. An extract from a book by British climber Matt Dickinson, published in 1997. Dickinson and his team are attempting to scale Mount Everest when a devastating storm strikes.
...
## Q5
**Marks:** 20 (12 content + 8 technical accuracy)
**AOs:** AO4, AO5
...
**Teaching Point:** Key concepts for EDUQAS Language Component 2 — 19th and 21st century non-fiction reading skills (engagement analysis, impressions, language analysis, comparison) and transactional/persuasive writing skills (articles, speeches, letters, leaflets). These notes support both Phase 1 (first draft) and Phase 2 (redraft) across all practice papers.
**Marks:** 0
**AOs:** none
...
**Type:** language_paper
**Format:** multi_question
**Teaching Point:** Standalone transactional writing exercise — Article form. Practice crafting a persuasive article with structured argumentation and engaging style. 20 marks: 12 for content/organisation and 8 for technical accuracy. Phase 1 (first draft) focuses on structure and argument; Phase 2 (redraft) refines style, vocabulary, and technical accuracy.
**Marks:** 20
**AOs:** AO4, AO5
...
**Type:** language_paper
**Format:** multi_question
**Teaching Point:** Standalone transactional writing exercise — Speech form. Practice crafting a persuasive speech with rhetorical techniques (direct address, tricolon, rhetorical questions, anecdote, emotive language). 20 marks: 12 for content/organisation and 8 for technical accuracy. Phase 1 (first draft) focuses on voice and rhetorical structure; Phase 2 (redraft) sharpens persuasive techniques and technical accuracy.
**Marks:** 20
**AOs:** AO4, AO5
...
**Type:** language_paper
**Format:** multi_question
**Teaching Point:** Standalone transactional writing exercise — Letter form. Practice crafting a formal persuasive letter with appropriate register, conventions (addresses, greeting, sign-off), and structured argumentation. 20 marks: 12 for content/organisation and 8 for technical accuracy. Phase 1 (first draft) focuses on tone and formal register; Phase 2 (redraft) strengthens argument and technical precision.
**Marks:** 20
**AOs:** AO4, AO5
...
**Type:** language_paper
**Format:** multi_question
**Teaching Point:** Standalone transactional writing exercise — Leaflet form. Practice crafting a persuasive leaflet with engaging subheadings, direct address, facts/statistics, and a clear call to action. 20 marks: 12 for content/organisation and 8 for technical accuracy. Phase 1 (first draft) focuses on layout-awareness and persuasive content; Phase 2 (redraft) refines tone, audience targeting, and technical accuracy.
**Marks:** 20
**AOs:** AO4, AO5
