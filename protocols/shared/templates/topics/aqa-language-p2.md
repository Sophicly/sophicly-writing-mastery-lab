...
**Teaching Point:** AQA Language Paper 2 Diagnostic — Writers' Viewpoints and Perspectives. Two non-fiction sources, five questions, 80 marks total. Section A tests reading (Q1-Q4), Section B tests transactional writing (Q5). Phase 1 (first draft) establishes your baseline; Phase 2 (redraft) targets specific improvements identified in assessment.
**Marks:** 80
...
You now need to refer only to Source B, London Snow by Arthur Munby. How does Munby use language to describe the effects of snow on London?
...
You now need to refer only to Source B, Idle Days in Patagonia by W H Hudson. How does Hudson use language to create a sense of danger and tension?
...
You now need to refer only to Source B, American Notes by Charles Dickens. How does Dickens use language to convey the horrors of solitary confinement?
...
You now need to refer only to Source B, The Arts of Beauty by Madame Lola Montez. How does Montez use language to warn her readers about commercial cosmetics?
...
You now need to refer only to Source B, An Essay Concerning Humane Understanding by John Locke. How does Locke use language to explain his theory of how the mind acquires knowledge?
