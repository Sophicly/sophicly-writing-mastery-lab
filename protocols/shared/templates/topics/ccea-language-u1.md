...
**Teaching Point:** CCEA Language Unit 1 Diagnostic — Personal Writing and Reading Non-Fiction. Two non-fiction sources, five questions, 80 marks total. Section A tests transactional writing (Q1), Section B tests reading (Q2-Q5). CCEA is unique: the writing section comes FIRST. Phase 1 (first draft) establishes your baseline; Phase 2 (redraft) targets specific improvements identified in assessment.
**Marks:** 80
...
Using Source A, lines 1 to 12, identify and explain what you learn about the approaching storm and its initial impact on those at base camp.

## Q3
**Marks:** 10
**AOs:** AO1

Using Source A and Source B, explain the differences between the way extreme weather is experienced in the two sources. Use evidence from both sources to support your answer.

## Q4
**Marks:** 10
**AOs:** AO2

Using Source B only, analyse how Munby uses language to describe the effects of snow on London. Support your answer with close reference to the text.

## Q5
**Marks:** 10
**AOs:** AO3

Using both Source A and Source B, compare how the two writers convey their different attitudes towards extreme weather. You should consider:
- the writers' different attitudes
- the methods the writers use to convey their attitudes.

---

# Topic 2: Conceptual Notes
**Type:** conceptual-notes
**Teaching Point:** Key concepts for CCEA Language Unit 1 — transactional writing skills (articles, speeches, letters, leaflets) and non-fiction reading skills (identifying information, synthesis, language analysis, comparison). CCEA places writing first on the paper. These notes support both Phase 1 (first draft) and Phase 2 (redraft) across all practice papers.
**Marks:** 0
**AOs:** none
...
**Type:** language_paper
**Format:** multi_question
**Teaching Point:** Standalone transactional writing exercise — Article form. Practice crafting a persuasive article using clear structure, engaging opening, developed arguments, and a strong conclusion. 40 marks: 24 for content/organisation (AO5) and 16 for technical accuracy (AO6). Phase 1 (first draft) focuses on structure and argument; Phase 2 (redraft) refines style, vocabulary, and technical accuracy.
**Marks:** 40
**AOs:** AO5, AO6
...
**Type:** language_paper
**Format:** multi_question
**Teaching Point:** CCEA Language Unit 1 Practice — Personal Writing and Reading Non-Fiction. Two non-fiction sources about perilous sea voyages, five questions, 80 marks total. Section A tests transactional writing (Q1), Section B tests reading (Q2-Q5). Phase 1 (first draft) and Phase 2 (redraft) target specific improvements identified in assessment.
**Marks:** 80
**AOs:** AO1, AO2, AO3, AO5, AO6
...
"Adventure and risk-taking are essential parts of a fulfilling life." Write a speech to be delivered at a school assembly in which you argue for or against this statement.
...
Using Source A, lines 1 to 11, identify and explain what you learn about the conditions Ben Fogle faced while rowing.

## Q3
**Marks:** 10
**AOs:** AO1

Using Source A and Source B, explain the similarities between the dangers faced by the writers during their sea voyages. Use evidence from both sources to support your answer.

## Q4
**Marks:** 10
**AOs:** AO2

Using Source B only, analyse how Hudson uses language to create a sense of danger and tension. Support your answer with close reference to the text.

## Q5
**Marks:** 10
**AOs:** AO3

Using both Source A and Source B, compare how the two writers convey their different experiences of being at the mercy of the sea. You should consider:
- the writers' different experiences
- the methods the writers use to convey their feelings.
...
**Type:** language_paper
**Format:** multi_question
**Teaching Point:** CCEA Language Unit 1 Practice — Personal Writing and Reading Non-Fiction. Two non-fiction sources about social injustice and punishment, five questions, 80 marks total. Section A tests transactional writing (Q1), Section B tests reading (Q2-Q5). Phase 1 (first draft) and Phase 2 (redraft) target specific improvements identified in assessment.
**Marks:** 80
**AOs:** AO1, AO2, AO3, AO5, AO6
...
Using Source A, lines 1 to 15, identify and explain what you learn about the London riots and the people involved.

## Q3
**Marks:** 10
**AOs:** AO1

Using Source A and Source B, explain the differences between how each writer presents the treatment of disadvantaged people. Use evidence from both sources to support your answer.

## Q4
**Marks:** 10
**AOs:** AO2

Using Source B only, analyse how Dickens uses language to convey the horrors of solitary confinement. Support your answer with close reference to the text.

## Q5
**Marks:** 10
**AOs:** AO3

Using both Source A and Source B, compare how the two writers convey their different perspectives on injustice in society. You should consider:
- the writers' different perspectives
- the methods the writers use to convey their viewpoints.
...
**Type:** language_paper
**Format:** multi_question
**Teaching Point:** CCEA Language Unit 1 Practice — Personal Writing and Reading Non-Fiction. Two non-fiction sources about cosmetics and beauty standards, five questions, 80 marks total. Section A tests transactional writing (Q1), Section B tests reading (Q2-Q5). Phase 1 (first draft) and Phase 2 (redraft) target specific improvements identified in assessment.
**Marks:** 80
**AOs:** AO1, AO2, AO3, AO5, AO6
...
Using Source A, lines 1 to 14, identify and explain what you learn about Mitchell's classification of cosmetics.

## Q3
**Marks:** 10
**AOs:** AO1

Using Source A and Source B, explain the differences between how each writer views the cosmetics industry. Use evidence from both sources to support your answer.

## Q4
**Marks:** 10
**AOs:** AO2

Using Source B only, analyse how Montez uses language to warn her readers about commercial cosmetics. Support your answer with close reference to the text.

## Q5
**Marks:** 10
**AOs:** AO3

Using both Source A and Source B, compare how the two writers convey their different attitudes towards vanity and the beauty industry. You should consider:
- the writers' different attitudes
- the methods the writers use to convey their perspectives.
...
**Type:** language_paper
**Format:** multi_question
**Teaching Point:** CCEA Language Unit 1 Practice — Personal Writing and Reading Non-Fiction. Two non-fiction sources about the nature of knowledge and understanding, five questions, 80 marks total. Section A tests transactional writing (Q1), Section B tests reading (Q2-Q5). Phase 1 (first draft) and Phase 2 (redraft) target specific improvements identified in assessment.
**Marks:** 80
**AOs:** AO1, AO2, AO3, AO5, AO6
...
Using Source A, lines 1 to 16, identify and explain what you learn about the limitations of scientific proof.

## Q3
**Marks:** 10
**AOs:** AO1

Using Source A and Source B, explain the similarities between how each writer views the role of observation and experience in gaining knowledge. Use evidence from both sources to support your answer.

## Q4
**Marks:** 10
**AOs:** AO2

Using Source B only, analyse how Locke uses language to explain his theory of how the mind acquires knowledge. Support your answer with close reference to the text.

## Q5
**Marks:** 10
**AOs:** AO3

Using both Source A and Source B, compare how the two writers convey their different perspectives on the nature and limits of human knowledge. You should consider:
- the writers' different perspectives
- the methods the writers use to convey their ideas.
