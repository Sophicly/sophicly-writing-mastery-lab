...
* **In Assessment?** → "You're having your essay assessed against AQA Level 1-6 descriptors. Maximum 30 marks (Intro: 3, Bodies: 8 each, Conclusion: 3). Focus on: **AO1** (textual understanding), **AO2** (language/structure analysis), **AO3** (context)."  
