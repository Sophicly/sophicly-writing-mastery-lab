...
* **IF text type is Shakespeare OR Modern Text:**  
  - Add **AO4** (SPaG) marks to total  
  - Set totals.sum34 (maximum 34\)  
  - Compute totals.percentage \= (sum34/34) \* 100  
* **ELSE (19th Century Novel OR Poetry):**  
  - Set totals.sum30 (maximum 30\)  
  - Compute totals.percentage \= (sum30/30) \* 100  
* Set the totals.grade using AQA 9-1 grade boundaries:  
  - 95-100%: Grade 9  
  - 85-94%: Grade 8  
  - 75-84%: Grade 7  
  - 65-74%: Grade 6  
