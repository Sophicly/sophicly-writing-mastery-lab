# **GCSE English Literature Mark Scheme Mastery Quiz: AQA Worlds & Lives (per-anthology) v1.0**

Per-TEXT mark-scheme-quiz bank for the **AQA 8702 Worlds and Lives** cluster (first examined 2025).
Served by `SWML_Quiz_Bank::pick_session()` via the canonical slug ladder (`worlds_lives_poetry.md`)
— this bank REPLACES the generic `poetry_anthology.md` for W&L lessons so every worked example comes
from a Worlds and Lives poem (never Love & Relationships / Power & Conflict).

**Mark-scheme facts are identical to the shared AQA anthology grid** (30 marks: AO1 12 / AO2 12 /
AO3 6; six levels; verbatim AQA band descriptors) — reused unchanged from the vetted generic bank.
Only the poem EXAMPLES are scoped to the W&L cluster: Lines Written in Early Spring · In a London
Drawingroom · England in 1819 · Shall Earth No More Inspire Thee · On an Afternoon Train · Thirteen ·
A Wider View · A Portable Paradise · Homing · With Birds You're Never Lonely · Pot · Name Journeys ·
A Century Later · Like an Heiress.
...
1. **Type: MCQ \[Tests AO Weighting\]**
   ...
   * **Correct:** A
   * **Feedback:** ✓ Correct. The AQA anthology question is 30 marks: 12 for argument (AO1), 12 for methods (AO2), 6 for context (AO3). AO4 SPaG does not apply to this paper.
   * **AO:** AO1
...
4. **Type: Select All That Apply \[Tests AO2 Poetry Methods\]**
   ...
   * **Feedback:** Imagery, form, and structure are all AO2 targets. Biography is context, not method. But a method only counts as AO2 analysis once you pair it with its effect on the reader (Focus/Feel/Think/Act) — naming "free verse" or "enjambment" alone is feature-spotting and earns low marks; you must say what the method makes the reader focus on, feel, think, or do.
   * **AO:** AO2
...
6. **Type: MCQ \[Tests Cluster Structure\]**
   ...
   * **Correct:** B
   * **Feedback:** ✓ Correct. There are three clusters: Power & Conflict, Love & Relationships and Worlds and Lives (Lines Written in Early Spring, In a London Drawingroom, A Portable Paradise), the last first examined from 2025. Students study just one cluster in depth.
   * **AO:** AO1
...
7. **Type: Fill-in-the-Blank \[Tests AO1 Argument\]**
   ...
   * **Feedback:** ✓ Correct. Treat poems as arguments, not stories. In a London Drawingroom isn't just about a grey city — it's about what industrial humanity has shut out of its own life.
   * **AO:** AO1
...
8. **Type: Select All That Apply \[Tests Level 6 Features\]**
   ...
   * **Correct:** A, B, C
   * **Scoring:** 2 marks for A, B, C. 1 mark if mostly correct.
   * **Feedback:** Integrated comparison, judicious evidence, and conceptual interpretation all define Level 6. Block treatment caps you lower. The interwoven structure is only the vehicle — within it you must compare the two poets' METHODS and their DIFFERING effects on the reader (e.g. "where Wordsworth's spring imagery makes the reader mourn 'what man has made of man', Eliot's unrelieved grey makes us feel a world drained of nature"); interweaving and connectors alone are not AO2 comparison.
   * **AO:** AO1
...
10. **Type: MCQ \[Tests Evaluative Vocabulary\]**
    ...
    * **Options:** A) "Shows", B) "Says", C) "Subtly renders" (e.g., "Eliot subtly renders the modern city lifeless through unrelieved grey imagery"), D) "Writes about".
    * **Correct:** C
    * **Feedback:** ✓ Correct. Evaluative verbs ("renders", "weaponises", "inverts") convert description into critical judgement — the Level 6 voice. The word only earns credit when it fronts a judgement about HOW the method affects the reader (e.g. "the unrelieved grey renders the city lifeless, leaving the reader to feel nature shut out of modern life"); dropped in alone it is an empty label.
    * **AO:** AO2
...
23. **Type: Select All That Apply \[Tests AO2 Methods\]**
    ...
    * **Options:** A) Imagery and specific word connotations, including dialect word choices, B) Form (free verse, list-poem, the extended metaphor), C) Structure (enjambment, stanza breaks, repetition), D) The poets' nationality and upbringing.
    * **Correct:** A, B, C
    * **Scoring:** 2 marks for A, B, C. 1 mark if mostly correct.
    * **Feedback:** Imagery, form and structure are all AO2 targets, and a method only counts once you pair it with its effect on the reader (Focus/Feel/Think/Act). Naming "free verse" or "repetition" alone is feature-spotting; the poets' nationality and upbringing is context about the writer, not a method on the page.
    * **AO:** AO2
...
25. **Type: Ranking \[Tests AO1\]**
    ...
    * **Options:** A) "Both poets frame the human world as an indictment of what people have made of themselves: one measures the city's grey monotony against a nature it has shut out, the other lets spring's quiet joy expose the grief of what man has made of man.", B) "Both poems are about nature and cities; one happens outdoors in spring and the other indoors in London.", C) "Both poems present the modern world as bleak, and each uses imagery of colour and light which supports this.", D) "Whereas Wordsworth contrasts natural delight with human sorrow through vivid spring imagery, Eliot renders the city lifeless through unrelieved grey imagery, making the reader judge industrial life."
    * **Correct:** B, C, D, A
    * **AO:** AO1
...
26. **Type: MCQ \[Tests Level 6\]**
    ...
    * **Correct:** B
    * **Feedback:** ✓ Correct. Level 6 demands a conceptualised approach to the full task supported by a range of judicious references — treating each poem as an argument about belonging (Robinson guarding an inherited "paradise"; Berry's loss and keeping of a home tongue), not a set of images to retell.
    * **AO:** AO1
...
27. **Type: MCQ \[Tests Conceptualised Response\]**
    * **Question:** Which thesis best shows the "conceptualised" reading AQA Level 6 rewards, comparing England in 1819 and In a London Drawingroom?
    * **Options:** A) "Both poems are about England and are quite negative.", B) "Both poems use imagery, such as light and colour.", C) "Both poets indict a nation that has betrayed its own people — Shelley piles up images of a decaying ruling class to argue the state is rotten at the top, while Eliot's shroud of grey shows a society that has smothered the very life and nature it depends on.", D) "England in 1819 is a political poem and In a London Drawingroom is a descriptive poem."
    * **Correct:** C
    * **Feedback:** ✓ Correct. Option C treats each poem as an argument about a nation failing its people, links method to concept, and sustains a comparison — the conceptualised, critical reading of Level 6. The others retell subject or spot features.
    * **AO:** AO1
    * **Why A:** Naming a shared mood in the vaguest terms is Level 1 gist, not a conceptualised argument through method.
    * **Why B:** "Both use imagery" spots a feature without saying what it means or does to the reader.
    * **Why D:** Labelling one political and one descriptive is category-tagging, the opposite of a conceptualised interpretation.
28. **Type: Fill-in-the-Blank \[Tests AO2 Effect\]**
    * **Question:** In A Portable Paradise, Robinson's use of his grandmother's \[BLANK\] voice — passing on the island "in your pocket" — makes the reader feel heritage as something carried, guarded and kept alive against a hostile world. (One word.)
    * **Answer:** dialect
    * **Feedback:** ✓ Correct. The dialect (the grandmother's inherited, non-standard voice) is the AO2 method; the mark comes from tying it to its effect — the reader feels belonging as an inheritance carried within, protected from erasure.
    * **AO:** AO2
    * **WhyWrong:** "Rhyme" or "metaphor" name other devices, but the specific method credited here is dialect — the inherited voice that carries the poem's sense of home.
