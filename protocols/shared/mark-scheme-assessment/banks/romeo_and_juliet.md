# Mark Scheme Assessment Bank — Romeo and Juliet
...
student JUDGE real writing against the EXACT mark-scheme descriptor wording, and forces them to
USE the mark scheme's own vocabulary rather than a simplified paraphrase. Keys + feedback live
...
2. **Type: Fill [Tests AO1]**
   ...
   * **WhyWrong:** The missing AQA word is "conceptualised" — treating the text as the vehicle for a concept is what lifts AO1 into Level 6.
