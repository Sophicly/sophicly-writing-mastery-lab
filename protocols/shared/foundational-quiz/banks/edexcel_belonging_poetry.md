...
7. **Type: MCQ [Tests Recognising the Poem]**
   @set:1
   * **Question:** Which poem takes its title from a word for a rite of passage into adulthood, mourning that the speaker never got "to cross the river boys of our tribe must cross / in order to die and come back grown"?
   * **Options:** A) Kumukanda, B) Us, C) Jamaican British, D) My Mother's Kitchen
   * **Correct:** A
   * **Feedback:** ✓ Correct. Kayo Chingonyi's "Kumukanda" borrows a word meaning initiation: raised "in a strange land", the speaker fears Tata's people would think him "unfinished — a child who never sloughed off the childish estate."
...
8. **Type: MCQ [Tests Form & Features]**
   ...
   * **Correct:** A
   * **Feedback:** ✓ Correct. The open free verse lets Chingonyi move between ordinary British memory — bathing his dying mother, "auntie broke the news" — and an imagined "alternate self" who greets him "in the language of my father / and my father's father and my father's father's father", without forcing either into a fixed shape.
...
10. **Type: MCQ [Tests Recognising the Poem]**
    @set:1
    * **Question:** Which poem opens "Mild the mist upon the hill / Telling not of storms to-morrow", before the speaker slips into memories of childhood?
    * **Options:** A) Mild the Mist Upon the Hill, B) Clear and Gentle Stream, C) Sunday Dip, D) To My Sister
    * **Correct:** A
    * **Feedback:** ✓ Correct. Emily Brontë's "Mild the Mist Upon the Hill" opens on hillside mist "telling not of storms to-morrow", then turns inward: "Oh, I'm gone back to the days of youth, / I am a child once more."
    * **Why B:** Clear and Gentle Stream addresses a stream directly, not a misted hillside.
    * **Why C:** Sunday Dip pictures a river bathing scene, not a meditation on mist and memory.
    * **Why D:** To My Sister calls a sibling outdoors on a spring day, not a reflection on a quiet, rain-washed evening.
...
11. **Type: MCQ [Tests Form & Features]**
    ...
    * **Correct:** A
    * **Feedback:** ✓ Correct. Brontë's tight, regular rhyming quatrains give the poem its settled, contemplative calm as it moves from the misted hill to "my father's sheltering roof."
...
12. **Type: MCQ [Tests Meaning & Effects]**
    ...
    * **Correct:** B
    * **Feedback:** ✓ Correct. The mist is "telling not of storms to-morrow", and rather than pressing for certainty, the speaker settles into contentment, drawn back to "dreamy scents of fragrance" that "breathe of other years."
...
16. **Type: MCQ [Tests Recognising the Poem]**
    @set:2
    * **Question:** Which poem opens "The morning road is thronged with merry boys / Who seek the water for their Sunday joys"?
    * **Options:** A) Sunday Dip, B) Clear and Gentle Stream, C) I Remember, I Remember, D) Kumukanda
    * **Correct:** A
    * **Feedback:** ✓ Correct. John Clare's "Sunday Dip" pictures boys thronging "the morning road" to "seek the water for their Sunday joys", savouring a shared moment of open-air freedom.
...
17. **Type: MCQ [Tests Form & Features]**
    ...
    * **Correct:** A
    * **Feedback:** ✓ Correct. Clare's characteristic close, affectionate attention to rural detail — boys who "bundle up the rushes for a boat" and ride it "beneath the willow trees" — gives "Sunday Dip" its vivid, grounded sense of place.
...
19. **Type: MCQ [Tests Recognising the Poem]**
    @set:2
    * **Question:** Which poem opens "Clear and gentle stream! / Known and loved so long", addressing the stream directly to hold on to a memory of home and childhood?
    * **Options:** A) Clear and Gentle Stream, B) Sunday Dip, C) Us, D) My Mother's Kitchen
    * **Correct:** A
    * **Feedback:** ✓ Correct. Robert Bridges's "Clear and Gentle Stream" speaks directly to the stream, recalling "the idle dream / Of my boyish day", using it as a lasting thread back to a remembered home.
...
20. **Type: Fill [Tests Form & Features]**
    @set:2
    * **Question:** "Clear and Gentle Stream" takes the form of an [BLANK] — a poem directly addressing a person, place or thing, here the stream itself, repeatedly hailed as "Clear and gentle stream!"
    * **Answer:** apostrophe
    * **Feedback:** ✓ Correct. Bridges uses apostrophe, speaking straight to the stream — "Clear and gentle stream! / Known and loved so long" — which lets the poem feel like an intimate, ongoing conversation with a remembered home.
...
25. **Type: MCQ [Tests Recognising the Poem]**
    @set:2
    * **Question:** Which poem is addressed to the speaker's brother, remembering how the two of them once turned "the pond amid the willows" into an ocean, reading of a great explorer's voyages together?
    * **Options:** A) Captain Cook / To My Brother, B) Us, C) Kumukanda, D) In Wales, wanting to be Italian
    * **Correct:** A
    * **Feedback:** ✓ Correct. Letitia Elizabeth Landon's "Captain Cook / To My Brother" recalls how the siblings "sail'd with him at sea" in imagination, calling the water-lilies "the South Sea islands, each flower a different isle" — before mourning that "we leave in leaving childhood, life's fairy land behind."
    * **Why B:** Us explores identity through language and heritage, not a shared childhood memory of an explorer.
    * **Why C:** Kumukanda concerns a missed rite of passage, not an explorer's example.
    * **Why D:** In Wales, wanting to be Italian imagines a different country, not a brother's childhood memory.
...
26. **Type: MCQ [Tests Form & Features]**
    ...
    * **Correct:** A
    * **Feedback:** ✓ Correct. Landon speaks straight to her brother throughout — "Do you recall the fancies of many years ago" — using direct address to make her reminiscence feel personal and intimate.
...
27. **Type: Fill [Tests Meaning & Effects]**
    @set:2
    * **Question:** In "Captain Cook / To My Brother", the siblings' shared reading of the explorer's voyages once made a sailor's life "mid the storm and strife" seem more golden than any other fortune — a childhood fantasy of [BLANK] the poem later mourns as lost.
    * **Answer:** adventure
    * **Feedback:** ✓ Correct. "No golden lot that fortune could draw for human life, / To us seemed like a sailor's, mid the storm and strife" — Landon recalls how Cook's voyages fired a shared fantasy of adventure, later mourned as belonging only to childhood.
    * **WhyWrong:** The word is "adventure" — the siblings' whole imaginative game with Cook's Voyages was built on a shared longing for a life of adventure, later mourned as a fantasy left behind with childhood.

28. **Type: MCQ [Tests Recognising the Poem]**
    @set:2
    * **Question:** Which poem imagines "being sixteen / in Wales, longing to be Italian", picturing herself lounging "by a Vespa with a cigarette" in "impossibly pointed shoes"?
    * **Options:** A) In Wales, wanting to be Italian, B) The Émigrée, C) Peckham Rye Lane, D) My Mother's Kitchen
    * **Correct:** A
    * **Feedback:** ✓ Correct. Imtiaz Dharker's "In Wales, wanting to be Italian" sets the speaker's actual Wales against this imagined, glamorous Italian self.
...
29. **Type: MCQ [Tests Form & Features]**
    ...
    * **Correct:** A
    * **Feedback:** ✓ Correct. Dharker builds the poem from a string of questions — "living in Glasgow, / dying to be French"; "being sixteen / in Wales, longing to be Italian" — pressing grey, actual places against a vivid, imagined foreign self.
...
34. **Type: MCQ [Tests Recognising the Poem]**
    @set:3
    * **Question:** Which poem crowds its South London street with "afro combs and mobile phones in the white heat" and "cornflower scrunchies, liquorice weaves"?
    * **Options:** A) Peckham Rye Lane, B) Us, C) My Mother's Kitchen, D) Sunday Dip
    * **Correct:** A
    * **Feedback:** ✓ Correct. A. K. Blakemore's "Peckham Rye Lane" builds its picture of belonging from vivid, everyday detail — "Knickers lie flaccid / in Primark" beside "afro combs and mobile phones" — the texture of one real London street.
...
35. **Type: Fill [Tests Form & Features]**
    @set:3
    * **Question:** "Peckham Rye Lane" builds its picture of the street through a [BLANK] of sensory, concrete details — knickers "flaccid in Primark", "afro combs", "cornflower scrunchies, liquorice weaves" — rather than a single continuous story.
    * **Answer:** list
...
37. **Type: MCQ [Tests Recognising the Poem]**
    @set:3
    * **Question:** Which poem turns over the word "us" itself — "each wave in the sea, all insides compressed" — to explore the poet's mixed British and South Asian heritage?
    * **Options:** A) Us, B) Kumukanda, C) Jamaican British, D) Clear and Gentle Stream
    * **Correct:** A
    * **Feedback:** ✓ Correct. Zaffar Kunial's "Us" turns over the layered meanings folded into a small, shared word — recalling how, as a Midlands child, "us equally meant me" — to explore his hybrid heritage.
...
38. **Type: MCQ [Tests Form & Features]**
    ...
    * **Correct:** A
    * **Feedback:** ✓ Correct. Kunial's close, patient attention to language — "I, being one, am Liverpool no less / cresting the Mexican wave of we or us" — becomes the way he approaches his own layered, hybrid identity.
...
40. **Type: MCQ [Tests Recognising the Poem]**
    @set:3
    * **Question:** Which poem sets statements like "Anglo nose. Hair straight. No way I can be Jamaican British" against "Eat callaloo, plantain, jerk chicken – I'm Jamaican", weighing a dual heritage?
...
41. **Type: MCQ [Tests Form & Features]**
    ...
    * **Correct:** A
    * **Feedback:** ✓ Correct. Short, paired statements — "the English boys at school made me choose: Jamaican, British?" — let each side of the speaker's identity be weighed against the other in turn.
...
42. **Type: Fill [Tests Meaning & Effects]**
    @set:3
    * **Question:** "Jamaican British" ultimately resists choosing between the speaker's two heritages — his father tells him, "you cannot love sugar and hate your sweetness" — instead holding both sides of his [BLANK] identity together.
    * **Answer:** dual
    * **Feedback:** ✓ Correct. Antrobus refuses to pick one heritage over the other; his father's words — "you cannot love sugar and hate your sweetness" — let his dual identity stand as a whole rather than being divided.
...
43. **Type: MCQ [Tests Recognising the Poem]**
    @set:3
    * **Question:** Which poem inherits "glasses, some tall and lean, others short and fat" and "rusty pots she doesn't throw away" from a mother who is, at 69, "planning another escape"?
    * **Options:** A) My Mother's Kitchen, B) Clear and Gentle Stream, C) Sunday Dip, D) Peckham Rye Lane
    * **Correct:** A
    * **Feedback:** ✓ Correct. Choman Hardi's "My Mother's Kitchen" uses this domestic detail — the mismatched glasses and pots, the mother's ninth fresh start — to hold memories of home and a life left behind.
