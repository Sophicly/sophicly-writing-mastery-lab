# Macbeth — Concept Notes (autofilled into the Conceptual Notes doc on FQ mastery)

Companion to `macbeth.md`. NOT a quiz bank — not parsed as questions. These are the pre-authored,
