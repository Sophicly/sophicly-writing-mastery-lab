...
1. **Setup Phase (Parts A & B):** Collection of information before assessment begins  
2. **Assessment Phase (Part C):** Integrated self-assessment and AI-led marking with feedback delivery
...
**Total:** 30 marks for all text types (Shakespeare, 19th Century, Modern Texts, Poetry)
...
* Per paragraph cycle:  
  ...
  - Step 7: Context integration (AO4)  
...
* ELIF polish\_focus is "context\_integration" OR "ao3": aspect\_label \= "Context Integration (AO4)"  
...
📌 Polish \> Improving: Context Integration (AO4)
