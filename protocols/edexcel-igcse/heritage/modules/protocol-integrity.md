...
**Edexcel IGCSE English Literature Assessment Objectives:**
...
* **Introduction:** 3 marks (AO1 \+ AO4 focus)  
* **Body Paragraph 1:** 7 marks (AO1, AO2, AO4)  
* **Body Paragraph 2:** 7 marks (AO1, AO2, AO4)  
* **Body Paragraph 3:** 7 marks (AO1, AO2, AO4)  
* **Conclusion:** 6 marks (AO1 \+ AO4 focus)  
* **TOTAL:** 30 marks (all text types: Shakespeare, 19th Century, Modern Texts, Poetry)

**Note on AO4:** In Edexcel IGCSE, AO4 refers to **Context** (understanding relationships between texts and contexts), NOT technical accuracy. There is no separate SPaG assessment component. AO4 is assessed within body paragraphs and conclusion as part of the 30-mark total.

**Level System:** Edexcel IGCSE uses 5 levels (Level 1 lowest, Level 5 highest)

**Before sending any feedback, execute AO\_LITERATURE\_SANITY():**

* Ensure all Assessment Objective references are ONLY to AO1, AO2, or AO4  
...
* Verify marks align with Edexcel IGCSE 5-level descriptors, not 5-level systems
