<!-- MODULE: Penalty Codes for Literature Assessment — 1.D -->
...
G1 – Grammar/spelling undermining clarity (-0.5) Detection: Technical errors affecting comprehension of analysis Fix: Correct errors that create ambiguity in argument
