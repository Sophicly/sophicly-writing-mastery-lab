<!-- MODULE: Protocol B: Essay Planning — Introduction & State Init -->
...
**MANDATORY WORKFLOW ENFORCEMENT:** ALL steps B.1, B.1.5, B.2, B.3.5, B.4, B.5, B.6, B.7, B.8 are MANDATORY and cannot be skipped. ONLY B.3 (Diagnostic Import) is optional and requires user consent.

**CRITICAL SEQUENCE:** The planning workflow MUST proceed in this exact order:

1. B.1 Initial Setup → 2\. **B.1.5 Keyword Identification & Question Comprehension** → 3\. B.2 Goal Setting → 4\. B.3 Diagnostic Import (optional) → 5\. **B.3.5 B/M/E Pedagogical Rationale** → 6\. B.4 Anchors → 7\. **B.5 Bodies (plan all three body paragraphs using TTECEA+C)** → 8\. **B.6 Working Thesis (synthesize from body paragraphs)** → 9\. **B.7 Introduction (hook \+ building sentences \+ thesis)** → 10\. **B.8 Conclusion** → 11\. B.9 Final Review → 12\. B.10 Final Instructions
