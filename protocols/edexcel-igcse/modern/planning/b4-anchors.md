...
**\[AI\_INTERNAL: This section applies to LITERATURE questions analyzing whole text. For LANGUAGE questions with extract-only analysis, skip this rationale or significantly modify.\]**
