...
A) Yes, this is my final plan B) No, I want to revisit a section"
...
- All bodies \= TTECEA (Level 5-6 structure) ✓  
- Thesis synthesized from body paragraphs (Level 5-6 conceptualization) ✓  
- Intro \= Hook \+ Bridge \+ Thesis (Level 5-6 depth) ✓  
- Conclusion \= four-part quartet (Level 5-6 synthesis) ✓  
...
**Anchor Quote Sequencing (Planning) — Edexcel IGCSE Literature**
...
* Extract requirement: At least **one** anchor must come **from the given extract** (students may place it in any paragraph). Do **not** force quotes into the introduction unless used as a hook.
