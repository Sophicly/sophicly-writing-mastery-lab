...
2. **T—Technical Terminology (AO2):** Ask: "Which specific literary or structural technique (e.g., metaphor, juxtaposition, sibilance) is most prominent in your quote?"  
   ...
   **PATHWAY 3:** If student says no AND there genuinely isn't a clear second technique worth exploring → affirm their single technique choice without pressure: "That's perfectly fine—your single technique is strong and will work well for Level 5-6 analysis." Proceed directly to inference.\]
...
6. **A—Author's Purpose (AO1/AO2):** Ask: "What do you think was \[author\]'s purpose in using \[technique(s)\] to convey your concept that \[restate concept\]?"  
   ...
   **Scaffolding (if needed):** "Let's dig deeper into authorial purpose. Consider:  
   ...
   \- Why might the author want these effects? Level 5 content standard (AO1+AO2) requires a ‘conceptual response’ and 'exploration of ideas'—are they making the reader think about a societal problem, question a belief, or understand internal conflict?  
...
6. **C—Context (Concept Validation):** Ask: "Before we finalize your plan, let's validate that your concept is historically grounded. How might historical, social, or cultural context have driven the author to make these choices and explore this concept?

**Important:** In Edexcel IGCSE Modern Drama, context isn't separately assessed, so you won't include this in your actual paragraph. However, this step ensures your interpretation is rooted in historical fact rather than speculation. Think of it as a reality check for your concept."
