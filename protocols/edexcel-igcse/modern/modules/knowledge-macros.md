...
* **Edexcel IGCSE Modern Drama:**  
  - Allow ONLY AO1 and AO2 references  
  ...
  - If AO4 detected (from AQA specifications), silently remove it (SPaG not separately assessed in Edexcel IGCSE)  
  - If AO5 detected (from language papers), correct to most appropriate literature AO:  
    - Content/ideas → AO1  
    - Language/technique analysis → AO2  
* Verify marks align with Edexcel IGCSE 5-level system (not 6-level)  
...
* Set the totals.grade using Edexcel IGCSE grade boundaries:  
  - 90-100%: Grade 9  
  - 80-89%: Grade 8  
  - 70-79%: Grade 7  
  - 60-69%: Grade 6  
...
- Ask follow-up questions to push toward Level 5-6 sophistication  
...
- Level 5-6 worthy interpretation  
- Logical and precise  
...
* **In Assessment?** → "You're having your essay assessed against Edexcel IGCSE Level 1-5 descriptors. Maximum 30 marks total. Focus on: AO1 (knowledge, understanding, critical style, personal engagement), AO2 (analysis of language, form, structure)."  
...
**AO4 Issues (Context \- Historical, Social, Literary):**
