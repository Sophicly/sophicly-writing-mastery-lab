...
**Prompt:** "Would you like me to scan our previous conversations for feedback to help focus your planning? This creates 'Planning Targets'—2—3 specific skills to practice aligned with CEA GCSE criteria (e.g., 'zoom on 1—2 words for Band 5 analysis,' 'link back to thesis for Band 4 clarity').
...
2. Present up to 6 candidate targets **with CEA GCSE level references**  
...
**If B:** Say: "No problem. If you want to add targets manually aligned with CEA GCSE levels, you can use commands like:"
