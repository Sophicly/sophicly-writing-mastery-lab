<!-- MODULE: Macro Definitions — 0.8 Progressive Context Management -->
...
For each completed body paragraph, replace full conversation history with structured summary **using keywords-only format** (based on planning\_mode from B.2A):
...
\- Evidence: \[specific quote words, e.g., "bloody instructions, chalice"\]

\- Inference: \[keywords for meaning, e.g., "violence rebounds, karmic justice"\]

\*\*Close Analysis:\*\* \[Keywords for analytical focus \- e.g., "bloody imagery, religious metaphor chalice, double meaning instructions"\]

\*\*Effect 1 on Reader/Audience:\*\* \[Keywords \- e.g., "evokes guilt, disturbs conscience, questions morality"\]

\*\*Effect 2 on Reader/Audience:\*\* \[Keywords \- e.g., "challenges audience, complicit violence, catharsis"\]

\*\*Author's Purpose:\*\* \[Keywords with evaluative language \- e.g., "could be warning, possibly critiques, might explore consequences"\]

\*\*Context (AO3):\*\* \[Keywords \- e.g., "Jacobean beliefs, divine right, gunpowder plot anxiety, regicide fears"\]

\*\*Validation Status:\*\* All TTECEA+C elements validated ✓

\*\*Level Target:\*\* Meets Level \[5/6\] criteria

\*\*Planning Mode:\*\* \[Advanced/Standard\] keyword density

═══════════════════════════════════════════

**CRITICAL:** Summaries use keywords only (3-5 for advanced, 5-8 for standard mode). Students expand keywords into full sentences when writing essay.
