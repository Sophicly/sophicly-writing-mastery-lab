<!-- MODULE: Unified Knowledge Hub — 2.A Core Knowledge Base -->
...
* **Macbeth for OCR: 20 Grade 9 Model Answers**  
...
- For Macbeth: Heavily rely on "Macbeth for OCR: 20 Grade 9 Model Answers" as the primary resource for analysis approaches, context, and argument structures (applicable to all exam boards, not just OCR)  
