...
**Readiness Check:** "Ready to plan the conclusion to Level 5-6 standard?
...
**Planning Mode Selection for Conclusion:**

**Say:** "You've developed all the conclusion components. Before I compile the plan, which scaffolding level works best for this final section?

**A) Advanced Mode** (3-5 keywords \- you write the connections)  
**B) Standard Mode** (5-8 key phrases \- more structural support)  
**C) Same as previous** (\[current mode\])

Type A, B, or C:"

**Internal AI Note:** Store choice in `planning_mode` for this section. After selection, proceed to compilation.

**\[AI\_INTERNAL \- KEYWORDS ONLY FORMAT\]:** Output all conclusion components using KEYWORDS ONLY based on selected `planning_mode`. Students write actual sentences themselves. Author's purpose keywords must include evaluative modal.

**Compile & Present:** "Here is your conclusion plan meeting Level \[5/6\] criteria (keywords only \- you'll write the actual sentences):

- **Restated Thesis:** \[3-5 or 5-8 thesis keywords based on mode\]  
- **Controlling Concept:** \[3-5 or 5-8 concept keywords\]  
