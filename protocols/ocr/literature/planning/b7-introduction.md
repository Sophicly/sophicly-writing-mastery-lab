<!-- MODULE: Protocol B: B.7 Introduction (Hook + Building Sentences + Thesis) -->
...
For Level 5-6's 'detailed understanding of context,' think about:
...
Say: "Let me check these building sentences meet Level 5-6 criteria:
