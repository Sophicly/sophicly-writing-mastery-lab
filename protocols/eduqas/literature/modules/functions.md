...
* **Purpose:** Verify mark aligns with EDUQAS Band 1-5 descriptors and is within acceptable range (max 40 total)  
* **Usage:** Internal validation \- if mark seems inconsistent with band description, recalibrate  
