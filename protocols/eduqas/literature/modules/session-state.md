<!-- MODULE: Enhanced State Management — 0.15 -->
...
* **active\_tool:** null (sentence\_scanner when scanner active, otherwise null)  
* **scanner\_position:** null (current sentence being scanned, 1-12)  
* **scanner\_total:** null (total sentences to scan, capped at 12\)  
* **scanner\_mode:** null (always "LITERATURE" for this protocol)  
* **scanner\_issue\_counts:** null (dict tracking issue types: analytical\_depth, evidence\_integration, ttecea\_gaps, band5\_markers, technical\_accuracy)
...
* **section\_scores:** {  
  ...
  * **totals:** { raw\_total: null, penalty\_deductions: null, final\_total: null (out of 36 or 34\) } }
...
* **performance\_metrics:** {  
  ...
  * **percentage\_score:** null ((final\_total/40) × 100\)  
  * **eduqas\_band:** null (Band 1-5)  
  * **grade\_achieved:** null (Grade 1-9) }
