<!-- MODULE: B.2A Keyword Identification & Question Analysis -->
...
**[AI_INTERNAL — Socratic Validation]:** After student responds, validate their keyword identification:
...
**[AI_INTERNAL]** If question includes extract, say: "I notice your question includes an extract. EDUQAS GCSE requires you to reference the extract in your essay. We'll ensure one of your three anchor quotes comes from this extract when we select quotes shortly."

**Store:** KEYWORDS = {primary: "[main focus]", secondary: "[supporting aspects]", scope: "[specific aspect if narrowed]"}
