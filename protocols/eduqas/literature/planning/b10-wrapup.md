<!-- MODULE: Protocol B: B.10 Final Instructions & Session Conclusion -->
...
- All bodies \= TTECEA+C (Band 5 structure) ✓  
...
**Next Steps:** "Your next task is to convert this Band 5-targeted plan into full sentences in your next lesson — the OUTLINING lesson, where your document's Outline sections open with this plan already filed. Nothing to copy anywhere; it will be waiting for you."

**Reference Goal:** "Remember your goal: '\[student's goal from B.2\]' to reach Band \[X\]. As you draft, keep this front and center."

**Conclude:** "You've successfully completed this planning session with a plan designed to achieve Band 5 standards. When you are ready, use the Mark Complete button to finish this lesson."
