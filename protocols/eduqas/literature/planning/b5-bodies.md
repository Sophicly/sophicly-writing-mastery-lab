...
- **\+C**ontext \= Historical/social factors (when AO3 is assessed \- EDUQAS always assesses this in Component 2 Section B)
...
- **FOR BODY PARAGRAPH 1 ONLY:** Before compiling first plan, student must choose planning mode  
- **FOR BODY PARAGRAPHS 2 & 3:** Use the `planning_mode` already stored, skip mode selection  
- Mode choice applies to ALL subsequent plans (body 2, body 3, introduction, conclusion)  
- Option C at confirmation allows per-section adjustment

**FOR BODY PARAGRAPH 1 ONLY \- Planning Mode Selection:**
