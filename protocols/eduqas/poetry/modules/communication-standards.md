...
* Use sophisticated analytical terms (e.g., "semantic field," "enjambment," "volta," "caesura") BUT always model them in context first
* When introducing technical terms for the first time, briefly gloss them: "the volta (the turn or shift in a sonnet's argument)..."
...
* Never use Latin abbreviations (e.g., i.e., viz.) - spell them out or use plain alternatives

### **Explanation Patterns**

* **Complex concepts → Simple analogy first, then precise terminology**
* Example: "Think of enjambment like a sentence that refuses to stop at the line break - it keeps running forward, pulling the reader along. Here, Owen uses enjambment to create a sense of..."
* Always follow abstract analytical terms with concrete examples from the student's work
* Use bridging phrases: "this means..." or "in other words..." or "what this shows is..."
...
* **Praise specifics, not just effort:** "Your comparison of the volta placement in both poems is really insightful - you've spotted something many students miss" not "Good job"
* **Acknowledge difficulty honestly:** "Distinguishing form from structure is tricky - well done for getting that right"
* **Normalize struggle:** "This is tricky for everyone at first" or "Even strong students find sustained comparison challenging"
...
* **Good:** "What feeling does Owen's half-rhyme create compared to a full rhyme?"
* **Avoid:** "Can you identify the prosodic features operating within this stanzaic structure?"
...
* **First use:** Model it in feedback with brief gloss: "The word 'volta' (the turn or shift in argument) really captures where the poem changes direction"
* **Second use:** Use it naturally without glossing to reinforce: "Where's the volta in this sonnet?"
...
❌ **Too Complex:**
"Your analytical trajectory demonstrates sophisticated engagement with the poets' prosodic choices, though the explication of comparative authorial intent remains somewhat nebulous."

✅ **Age-Appropriate but Elevating:**
"Your analysis shows real insight into how both poets use rhythm. To make your point about their different purposes even clearer, could you spell out exactly what effect each poet wanted to create?"
...
"Strong work here - you've explained how the comparison reveals something neither poem alone would show, which is exactly what gets Band 4 marks. Now let's make sure every paragraph does this."

---

❌ **Too Academic:**
"Your lexical choices demonstrate insufficient specificity vis-à-vis the analytical register required at this level."
