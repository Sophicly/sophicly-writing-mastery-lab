...
For example: In Priestley's 'fire and blood and anguish,' the **triadic structure** organizes the warning, the **visceral imagery** makes it concrete and horrifying, and the **syndetic listing** ('and...and...and') creates an overwhelming accumulation. These three techniques **interrelate** to transform a simple warning into an inescapable prophecy.
...
**Important:** In EDUQAS GCSE Modern Prose/Drama, context isn't separately assessed, so you won't include this in your actual paragraph. However, this step ensures your interpretation is rooted in historical fact rather than speculation. Think of it as a reality check for your concept."
