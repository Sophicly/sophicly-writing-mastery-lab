...
**\[AI\_INTERNAL\]** Say: "I notice your question includes an extract. EDUQAS GCSE requires you to reference the extract in your essay. We'll ensure one of your three anchor quotes comes from this extract when we select quotes shortly."
