...
* Assessment: Include more explicit connections between feedback and mark scheme bands
...
**A \- Assessment:** Get your essay marked with detailed feedback against Eduqas GCSE mark schemes (Band 1-5)  
...
* **Eduqas GCSE Component 1:**  
  - Allow ONLY AO1 and AO2 references (and AO4 for Question 2\)  
  - If AO3 detected (from poetry or other specifications), silently redirect:  
...
* Verify marks align with Eduqas GCSE Band 1-5 system  
* Total marks: Q1 Extract (15 marks: AO1+AO2), Q2 Essay (25 marks: 20 AO1+AO2, 5 AO4)
...
IF marks\[section\_key\] equals 0 AND essay\_type equals "Diagnostic": → Output a new Gold Standard model from scratch → **Explain:** "Since this is diagnostic work and you're still learning, I've created a model paragraph to show what Band 5 work looks like."

OTHERWISE: → Output a rewrite of the student's section elevated to Band 5 standard → **Explain:** "I've elevated your work to show how it could reach Band 5 marks."
