...
IF student insists they don't have workbook/can't find it → Increment to Hint Level 4
...
Say: "Perfect. Now draft a working **comparative thesis** that states this overarching concept and foreshadows your three comparative proving points (Form, Structure, Language). Aim for the 'precise' and 'perceptive' comparative language that Level 6 requires."
