...
**Gold Standard Model – Question 2 (AO2 \- 8 Marks Total)**
...
(C)lose Analysis: This movement from a wider perspective to such a tightly focused internal view effectively mimics how an obsession consumes the mind, pushing aside all other thoughts.
...
(E)ffect on Reader 2: Moreover, this deliberate manipulation of focus ensures an audience's concern shifts from her physical discomfort to a more profound anxiety about her psychological stability.

(A)uthor's Purpose: Arguably, the writer employs this structural shift to demonstrate how an oppressive environment can dismantle a person's psyche, making a broader point about the connection between external hardship and internal collapse.
...
#### **Q4 Introduction Criteria**

* **Clarity and Flow:** Achieves a clear and logical flow of ideas, avoiding ambiguity.  
* **Transitions:** Uses effective transitional phrases to link the opening statement to the thesis.  
* **Sentence Construction:** Employs strong, varied sentence starters and structures, with secure spelling, punctuation, and grammar.  
* **Vocabulary:** Uses sophisticated, formal, and precise academic vocabulary.  
* **Argument:** Develops a clear, debatable thesis statement that establishes the main points of the evaluation.  
* **Interpretation:** Provides a precise, developed, and perceptive stance in relation to the prompt.

#### **Body Paragraph Criteria (Q2, Q3, Q4)**

**Internal AI Note:** The TTECEA structure is the gold-standard model used for body paragraphs across Q2, Q3, and Q4. It stands for: Topic sentence, Technique, Evidence, Connotation/Inference, Effect on the reader, and Author's purpose. All body paragraph models for these questions follow this structure. Questions 2 and 3 assess AO2 (language and structure analysis). Question 4 assesses AO4 (evaluation) but uses the same TTECEA structure.
...
#### **Q4 Conclusion Criteria**

* **Clarity and Flow:** Achieves a clear and logical flow of ideas, avoiding ambiguity.  
* **Transitions:** Uses effective transitional phrases to signal a conclusion.  
* **Sentence Construction:** Employs strong, varied sentence starters and structures, with secure spelling, punctuation, and grammar.  
* **Vocabulary:** Uses sophisticated, formal, and precise academic vocabulary.  
* **Argument & Synthesis:** Develops clear links between ideas, synthesising the argument rather than retelling points.  
* **Interpretation:** Provides a perceptive and conclusive evaluation that leaves a lasting impression.
