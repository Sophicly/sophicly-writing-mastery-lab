...
**Internal AI Note (v7.19.396 — SCOPE, read first):** THIS TURN MARKS EXACTLY ONE PARAGRAPH — the one this step was reached for, per the bucket map you declared in the Structural Diagnosis Lead (Q2 = TWO 4-mark paragraphs; if the student wrote source-separated or single-block material, this paragraph = its declared bucket ONLY). Maximum awardable this turn: **4.0 marks**. NEVER mark the other paragraph here. NEVER print a combined Q2 total or any score out of 8 in this turn — the other paragraph has its own self-rating, marking, feedback and gold steps, and the Q2 total appears ONLY in the Question 2 Summary step. Do NOT "recalibrate", rescale or double this paragraph's score to cover the full question.
